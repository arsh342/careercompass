  ...
  const fetchDashboardData = async () => {
    if (user) {
      ...
      try {
        ...
        const chartPostings = sortedPostings
          .slice(0, 5)
          .map((p) => ({
            title:
  ...
  const handleUpdateStatus = async (
    ...
    try {
      ...
      toast({
        ...
        description: `The job posting has been successfully ${
        ...
        <div className="grid gap-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  All job opportunities you have created.
                </p>
              </CardContent>
            </Card>
            <Card>
          ...
          <div className="grid gap-6 md:grid-cols-5">
            <Card className="md:col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  Your 5 most recently created job opportunities.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {postings.length === 0 ? (
                    ...
                    <TableBody>
                      {postings.slice(0, 5).map((posting) => (
                        <TableRow key={posting.id}>
                          ...
                          <TableCell className="text-right">
                            {format(posting.createdAt.toDate(), "PPP")}
                          </TableCell>
                          <TableCell>
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuItem asChild>
                                  <Link
                                    href={`/employer/postings/${posting.id}/edit`}
                                  >
                                ...
                                {posting.status === "Archived" ? (
                                  <DropdownMenuItem
                                    onClick={() =>
                                      handleUpdateStatus(posting.id, "Active")
                                    }
                                  >
                                  ...
                                  <DropdownMenuItem
                                    onClick={() =>
                                      handleUpdateStatus(posting.id, "Archived")
                                    }
                                  >
                                  ...
                                  <AlertDialogContent>
                                    <AlertDialogHeader>
                                      ...
                                      <AlertDialogDescription>
                                        ...
                                        permanently delete this job posting and
                                        all related data.
                                      </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
            ...
            <Card className="md:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  Top candidates based on your active postings.
                </CardDescription>
              </CardHeader>
              <CardContent>
                {loadingCandidates ? (
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                A look at how many applicants your 5 most recent job postings
                have received.
              </CardDescription>
            </CardHeader>
            <CardContent>
